...
<body>
    ...
    <div class="container"> 
    <form class="form needs-validation "  ng-app="myApp" ng-controller="validateCtrl" name="myForm" method="POST" novalidate  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
        <div class="row">
            <div class="col-sm-12 col-md-6">
            <label for="firstname" class="form-label mt-2 st">First name</label>
            <input type="text"  class="form-control inputst" ng-model="firstname" id="firstname" name="firstname" autocomplete="off" required>
        ...
        <div class="col-sm-12 col-md-6">
            ...
            <input type="text" class="form-control inputst" id="lastname" name="lastname" autocomplete="off"   required>
        </div> 
    </div>
        <div class="row"> 
        <div class="col-sm-12 col-md-6">
            <label for="email" class="form-label mt-2 st">Email</label>
            <input type="email" pattern=".+@gmail\.com" class="form-control inputst" id="mail" autocomplete="off" name="email" required>
            <div class="invalid-feedback">
          ...
          <select required class="form-select inputst mb-2" name="subject" aria-label="Default select example">
...
<div class="row">
    <div class="col-sm-12 col-md-6">
        ...
        <input type="password"  title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" minlength="5" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control inputst" id="password" name="password" required>
    </div>
    <div class="col-sm-12 col-md-6">
        <label for="cpassword"   class="form-label st mt-2">Confirm Password</label>
        <input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  name="conformpassword" class="form-control inputst" id="cpassword" name="password" required>
    </div>
    <?php if (!empty($pass)) { ?>
   ...
   <div class="row mt-2">
         ...
         <div class="col-sm-12 col-md-6">
            ...
            <label for="cou"  class="stu">semister-1</label>
                <input class="mr-2 std"  id="cou" type="checkbox" name="course1"
                 value="First-semister"  /> <br>
            <label for="cour"  class="stu">semister-2</label>
                <input class="ml-2 std mr-3"  id="cour" type="checkbox" 
                name="course2" value="Second-semister"  /> 
                <?php 
                   if(!empty($checkbox)){
                    ?><span class="error"> <?php echo $checkbox ?></span> <?php 
                   }
                ?>
        ...
        <div  class="col-sm-12 col-md-6">
            ...
            <label class="stu"><input id="gen" type="radio" name="gender" value="male" required> Male</label><br>
            <label  class="stu"><input id="gen" type="radio" name="gender" value="female" required> Female</label><br>
        ...
        <div class="g-recaptcha" data-sitekey="6Le7VcYnAAAAANgYd_rAR2vtJAu8m07mWKmHiVLG"></div>
           <?php 
              if(!empty($check)){
                 ?> <span class="error"> <?php echo  $check ; ?></span> <?php
              }
             ?>
    ...
    <script src="https://code.jquery.com/jquery-3.5.1.slim.min.js"></script>
        ...
        <script>
            // Disable form submissions if there are any invalid fields
            (function () {
                "use strict";
